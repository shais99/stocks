...
export const Portfolio = observer(() => {
    ...
    const onAddStock = async symbol => {
        ...
        const stock = stockStore.searchedStocks.find(stock => stock.symbol === symbol)
    ...
    return (
        <Flex vertical={true} justify="space-between" align="center">
            {!userStore.user && <Alert
                message={<>Please set your username to add stocks <Link to={'/change-user'}>here</Link></>}
                type="warning"
